...
/// <summary>
/// Thin wrapper over the API's HTTP surface. Works identically whether
/// this component tree is running server-side or as WebAssembly (Blazor
/// "Auto" render mode) - the HttpClient's BaseAddress is configured
/// differently for each host (see both Program.cs files) but the calls
